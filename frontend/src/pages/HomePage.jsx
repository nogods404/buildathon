...
export default function HomePage() {
  ...
  async function handleConfirmSend() {
    ...
    try {
      ...
      const gasPriceWithBuffer = '0x' + (BigInt(gasPrice) * 12n / 10n).toString(16) // 20% buffer
      ...
      const result = await api.confirmTransfer(preparedTransfer.id, txHash, connectedAddress)
    ...
    return (
      <div className="min-h-screen flex flex-col safe-top safe-bottom">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4">
          ...
          <h1 className="text-2xl font-bold mb-2 text-center">Send ETH via Telegram</h1>
          <p className="text-dark-400 text-center mb-8 max-w-xs">
            Connect your wallet to send ETH to anyone using their Telegram handle
          </p>
          ...
          <div className="glass rounded-2xl p-4 border-emerald-500/30">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium">Sent {recentTransfer.amount} ETH</p>
                  <p className="text-sm text-dark-400">to @{recentTransfer.recipient}</p>
                </div>
              </div>
              <button
      ...
      <div className="flex-1 px-4 flex flex-col">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg font-mono text-primary-400">"send 0.01 eth to @alice"</p>
          </div>
        </div>
